...
// Compact integers: least-significant digit first base-128 encoding; the high bit in each byte signifies whether another digit follows
...
//   BER integer: key length
//   key
//   if mode==1: BER integer: data length
//   if mode==1: data
// 0 byte
...
bool CLogDB::Load_()
{
    do
    {
        ...
        if (getc(file) != 0xCC) return false;
